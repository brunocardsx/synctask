...
interface AddColumnButtonProps {
  boardId: string;
  onColumnAdded: (column: ColumnType) => void;
}
...
const createColumn = async (boardId: string, title: string): Promise<ColumnType> => {
  ...
  <form onSubmit={handleSubmit} className={createFormClassName()}>
    ...
    <div className="flex gap-2">
      <button
        ...
        className={createSubmitButtonClassName(isLoading, !validateColumnData(title))}
      >
